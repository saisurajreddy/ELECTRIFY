...
- (void)viewDidLoad
{
    ...
    else
    {
        ...
        self.but15.hidden=NO;
        self.but21.hidden=NO;
        self.but22.hidden=NO;
        self.but23.hidden=NO;
        self.but24.hidden=NO;
        self.but25.hidden=NO;
        self.but31.hidden=NO;
        self.but32.hidden=NO;
        self.but33.hidden=NO;
        self.but34.hidden=NO;
        self.but35.hidden=NO;
        self.but41.hidden=NO;
        self.but42.hidden=NO;
        self.but43.hidden=NO;
        self.but44.hidden=NO;
        self.but45.hidden=NO;
        self.but51.hidden=NO;
        self.but52.hidden=NO;
        self.but53.hidden=NO;
        self.but54.hidden=NO;
        self.but55.hidden=NO;
        ...
        if(a[0][4]==1)
        {
            [but15 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];            
        }
        if(a[1][0]==1)
        {
        ...
        if(a[1][4]==1)
        {
            [but25 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];            
        }
        if(a[2][0]==1)
        {
        ...
        if(a[2][4]==1)
        {
            [but35 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];            
        }
        if(a[3][0]==1)
        {
        ...
        if(a[3][4]==1)
        {
            [but45 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];            
        }
        if(a[4][0]==1)
        {
            [but51 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];            
        }
        if(a[4][1]==1)
        {
            [but52 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];            
        }
        if(a[4][2]==1)
        {
            [but53 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];            
        }
        if(a[4][3]==1)
        {
            [but54 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];            
        }
        if(a[4][4]==1)
        {
            [but55 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];            
        }
        /*if(level==1)
        {
            [but12 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];
            ...
            switch (i)
            {
                case 1:switch (r)
                {
                    ...
                    case 4:printf("41\t");
                        ...
                        break;
                    case 5:printf("51\t");
                        if ([but51.imageView.image isEqual:[UIImage imageNamed:@"unglow.jpg"]])
                        {
                            [but51 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        ...
                        {
                            [but51 setImage:[UIImage imageNamed:@"unglow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        break;
                ...
                case 2:switch (r)
                {
                    ...
                    case 5:printf("52\t");
                        if ([but52.imageView.image isEqual:[UIImage imageNamed:@"unglow.jpg"]])
                        {
                            [but52 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        ...
                        {
                            [but52 setImage:[UIImage imageNamed:@"unglow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        break;
                    default:
                ...
                case 3:switch (r)
                {
                    ...
                    case 4:printf("43\t");
                        ...
                        break;
                    case 5:printf("53\t");
                        if ([but53.imageView.image isEqual:[UIImage imageNamed:@"unglow.jpg"]])
                        {
                            [but53 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        ...
                        {
                            [but53 setImage:[UIImage imageNamed:@"unglow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        break;
                    default:
                ...
                case 4:switch (r)
                {
                    ...
                    case 4:printf("44\t");
                        ...
                        break;
                    case 5:printf("54\t");
                        if ([but54.imageView.image isEqual:[UIImage imageNamed:@"unglow.jpg"]])
                        {
                            [but54 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        ...
                        {
                            [but54 setImage:[UIImage imageNamed:@"unglow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        break;
                    default:
                ...
                {
                    case 1:printf("15\t");
                        if ([but15.imageView.image isEqual:[UIImage imageNamed:@"unglow.jpg"]])
                        {
                            [but15 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        ...
                        {
                            [but15 setImage:[UIImage imageNamed:@"unglow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        break;
                    case 2:printf("25\t");
                        if ([but25.imageView.image isEqual:[UIImage imageNamed:@"unglow.jpg"]])
                        {
                            [but25 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        ...
                        {
                            [but25 setImage:[UIImage imageNamed:@"unglow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        break;
                    case 3:printf("35\t");
                        if ([but35.imageView.image isEqual:[UIImage imageNamed:@"unglow.jpg"]])
                        {
                            [but35 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        ...
                        {
                            [but35 setImage:[UIImage imageNamed:@"unglow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        break;
                    case 4:printf("45\t");
                        if ([but45.imageView.image isEqual:[UIImage imageNamed:@"unglow.jpg"]])
                        {
                            [but45 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        ...
                        {
                            [but45 setImage:[UIImage imageNamed:@"unglow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        break;
                    case 5:printf("55\t");
                        if ([but55.imageView.image isEqual:[UIImage imageNamed:@"unglow.jpg"]])
                        {
                            [but55 setImage:[UIImage imageNamed:@"glow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        ...
                        {
                            [but55 setImage:[UIImage imageNamed:@"unglow.jpg"] forState:UIControlStateNormal];
                            break;
                        }
                        break;
                    default:
                                        ...
                                        if ([but33.imageView.image isEqual:[UIImage imageNamed:@"glow.jpg"]]) 
                                        {
                                            ...
                                            if ([but41.imageView.image isEqual:[UIImage imageNamed:@"glow.jpg"]]) 
                                            {
                                                if ([but42.imageView.image isEqual:[UIImage imageNamed:@"glow.jpg"]]) 
                                                {
                                                    if ([but43.imageView.image isEqual:[UIImage imageNamed:@"glow.jpg"]]) 
                                                    {
                                                        if ([but51.imageView.image isEqual:[UIImage imageNamed:@"glow.jpg"]]) 
                                                        {
                                                            if ([but52.imageView.image isEqual:[UIImage imageNamed:@"glow.jpg"]]) 
                                                            {
                                                                if ([but53.imageView.image isEqual:[UIImage imageNamed:@"glow.jpg"]]) 
                                                                {
                                                                    if ([but14.imageView.image isEqual:[UIImage imageNamed:@"glow.jpg"]]) 
                                                                    {
                                                                        if ([but15.imageView.image isEqual:[UIImage imageNamed:@"glow.jpg"]]) 
                                                                        {
                                                                            if ([but24.imageView.image isEqual:[UIImage imageNamed:@"glow.jpg"]]) 
                                                                            {
                                                                                if ([but25.imageView.image isEqual:[UIImage imageNamed:@"glow.jpg"]]) 
                                                                                {
                                                                                    if ([but34.imageView.image isEqual:[UIImage imageNamed:@"glow.jpg"]]) 
                                                                                    {
                                                                                        if ([but35.imageView.image isEqual:[UIImage imageNamed:@"glow.jpg"]]) 
                                                                                        {
                                                                                            if ([but44.imageView.image isEqual:[UIImage imageNamed:@"glow.jpg"]]) 
                                                                                            {
                                                                                                if ([but45.imageView.image isEqual:[UIImage imageNamed:@"glow.jpg"]]) 
                                                                                                {
                                                                                                    if ([but54.imageView.image isEqual:[UIImage imageNamed:@"glow.jpg"]]) 
                                                                                                    {
                                                                                                        if ([but55.imageView.image isEqual:[UIImage imageNamed:@"glow.jpg"]]) 
                                                                                                        {
                                                                                                            NSLog(@"succeded dude");
                                                                                                            self.viewer.hidden=NO;
                                                                                                        }
